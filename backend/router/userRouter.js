...
const { addUser, getUsers, getJoueurByAge, getChild, addChild, playersNoLevel } = require("../controller/userController");
...
router.get("/joueur/no-level",[AuthenticationToken],playersNoLevel);
